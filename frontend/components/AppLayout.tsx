        ...
        {user && (
          <div className="flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-sm text-secondary hover:text-primary flex items-center gap-1.5 transition-colors duration-150"
            >
            ...
            <button
              ...
              className="text-xs text-muted hover:text-secondary px-3 py-1.5 rounded-lg border border-white/[0.07] hover:border-white/20 transition-all duration-150"
            >
              로그아웃
            </button>
          </div>
