...
import { getPullRequests } from '@/api/client'
...
export default function PullRequestsPage() {
  ...
  }, [riskFilter, stateFilter, decisionFilter])
            ...
            <tbody>
              {prs.map(pr => (
                <tr key={pr.id} className="border-b border-white/[0.04] last:border-0 hover:bg-white/[0.02] transition-colors">
                  <td className="px-5 py-3 text-muted text-xs whitespace-nowrap">{pr.repo_owner}/{pr.repo_name}</td>
