...
export default function LandingPage() {
  return (
    ...
    >
      ...
      >
        <span
          className="text-lg font-semibold text-white tracking-tight shrink-0"
        ...
        <nav className="flex-1 flex items-center justify-center gap-8">
          <Link
            href="/docs"
            className="text-base text-secondary hover:text-primary transition-colors duration-150"
          >
            Docs
          </Link>
          <a
            ...
            className="text-base text-secondary hover:text-primary transition-colors flex items-center gap-1.5"
          >
        ...
        <Link
          href="/login"
          className="text-sm font-medium px-4 py-1.5 rounded-lg transition-all duration-150 text-white shrink-0"
